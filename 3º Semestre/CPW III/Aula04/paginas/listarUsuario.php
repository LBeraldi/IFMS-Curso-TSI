                    ...
                    if ($qtd > 0) {
                        while ($row = $res->fetch_object()) {
                            ...
                            echo "<td>
                                ...
                                <button onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='../sistema/cad.php?&acao=excluir&id=" . $row->id . "';}else{false;}\" class='btn btn-danger'>Excluir</button> 
                            </td>";
                        }
                    } else {
